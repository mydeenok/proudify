<x-emails.layout hero-title="Subscription Cancelled" hero-subtitle="A tenant plan was deactivated" :preheader="($userSubscription->user?->organization_name ?? 'A tenant').' subscription cancelled'">
    ...
    <p>
        ...
        ({{ $userSubscription->user?->email }}) was cancelled.
    </p>
