...
<head>
    <x-head title="Certificate Verification" />
</head>
<body class="min-h-screen flex flex-col bg-floor font-body-md text-on-background antialiased">
    <main class="flex-grow flex items-center justify-center py-2xl px-md sm:px-margin">
        <div class="w-full max-w-5xl">
            @if ($certificate)
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-gutter items-start">
                    ...
                    <div class="lg:col-span-4 flex flex-col gap-lg">
                        <div class="glass-panel p-lg rounded-xl flex flex-col items-center text-center gap-md bento-shadow">
                            ...
                            <div class="grid grid-cols-2 gap-y-md gap-x-sm">
                                ...
                                <div class="flex flex-col gap-base col-span-2">
                                    ...
                                    <div class="flex items-center gap-sm">
                                        ...
                                        <button type="button" data-copy="{{ $certificate->verification_code }}" class="p-xs rounded-lg border border-outline-variant text-on-surface-variant hover:text-primary hover:border-primary transition-colors" title="Copy ID">
                        ...
                        <div class="glass-panel p-lg rounded-xl flex flex-col gap-md bento-shadow">
                            ...
                            <button type="button" data-copy="{{ $certificate->verify_url }}" class="btn-secondary w-full">
            ...
            @else
                <div class="max-w-md mx-auto glass-panel p-2xl rounded-xl text-center bento-shadow">
                    ...
                    <a href="/" class="btn-primary mt-lg inline-flex">
                        <x-application-logo variant="icon" href="/" class="pointer-events-none" />
                        Back to Proudify
                    </a>
                </div>
            @endif
    ...
    <footer class="py-lg text-center">
        <x-application-logo variant="brand" href="/" class="justify-center" />
    </footer>
</body>
</html>
