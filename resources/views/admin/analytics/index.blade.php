...
<x-layouts.admin-shell title="Analytics">
    ...
    >
        <x-slot:actions>
            <div class="hidden lg:flex items-center bg-surface-container-lowest border border-outline-variant rounded-lg px-sm py-xs">
                <span class="material-symbols-outlined text-on-surface-variant mr-xs text-[20px]">calendar_today</span>
                <span class="font-label-md text-label-md text-on-surface">Last 30 Days</span>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-gutter mb-gutter">
        ...
        <div class="card-surface bento-shadow p-lg">
            <p class="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider mb-xs">Certificates issued (all time)</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-gutter">
        ...
        <div class="col-span-12 bg-surface border border-outline-variant rounded-xl p-lg bento-shadow relative overflow-hidden">
        ...
        {{-- Users by Plan donut --}}
        <div class="col-span-12 md:col-span-4 bg-surface border border-outline-variant rounded-xl p-lg bento-shadow flex flex-col">
            <div class="mb-xl">
        ...
        <div class="col-span-12 md:col-span-8 bg-surface border border-outline-variant rounded-xl p-lg bento-shadow flex flex-col">
            <div class="mb-xl flex justify-between items-start">
                <div>
                    ...
                    <p class="font-body-sm text-body-sm text-on-surface-variant mt-1">Daily documents generated — last 30 days.</p>
                </div>
        ...
        {{-- Top templates table --}}
        <div class="col-span-12 bg-surface border border-outline-variant rounded-xl p-lg bento-shadow">
