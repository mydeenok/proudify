...
<body class="bg-floor min-h-screen flex items-center justify-center p-md antialiased selection:bg-primary selection:text-on-primary">
    ...
    <main class="w-full max-w-[440px] relative z-10">
        <div class="bg-surface-container-lowest border border-outline-variant rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-xl sm:p-margin flex flex-col gap-xl relative overflow-hidden">
            ...
            <header class="flex flex-col items-center text-center gap-sm mt-xs">
                <h1 class="font-headline-xl text-headline-xl text-primary font-black tracking-tighter">{{ config('app.name') }}</h1>
                @isset($header)
